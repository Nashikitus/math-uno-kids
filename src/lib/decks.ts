...
export const PRODUCTS: Produto[] = [
  {
    ...
    url: "https://blobs.vusercontent.net/blob/math-uno-complete-deck-GjJRqu01DU0klcvy2awFn7HDpAIZ3r.pdf",
  ...
  },
  {
    ...
    url: "https://blobs.vusercontent.net/blob/math-uno-fifa-world-cup-2026-Gtlm1tHQjsBdTrfUC3hGesayb7XK6M.pdf",
  ...
  },
  {
    ...
    url: "https://blobs.vusercontent.net/blob/paper-dolls-complete-bundle-mjS0PkyUuDk5019pieHGt29LYIndaK.pdf",
    ...
    files: [
      ...
      },
      {
        ...
        pages: 7,
        url: "https://blobs.vusercontent.net/blob/paper-dolls-rumi-coCVsNtQNiwr2ECTWnkgkoByDkmLVN.pdf",
      ...
      },
      {
        ...
        pages: 6,
        url: "https://blobs.vusercontent.net/blob/paper-dolls-extra-set-H7lN6tsjCY0ljd2nGvOe143h48sW0V.pdf",
      ...
      },
      {
        ...
        pages: 8,
        url: "https://blobs.vusercontent.net/blob/paper-dolls-dark-skin-brown-hair-prBg420sF2LJ04URn8H3gwM1ZcU2sv.pdf",
      ...
      },
      {
        ...
        pages: 5,
        url: "https://blobs.vusercontent.net/blob/paper-dolls-iphone-craft-JbG1cSlKldLY79hGKCDyIxKbknpl0j.pdf",
