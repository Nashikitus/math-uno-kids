...
export const PRODUCTS: Produto[] = [
  {
    ...
    url: "https://blobs.vusercontent.net/blob/math-uno-complete-deck-PT-BR-rgUY4YUzPcsvUlLtmyVMOrZiVGw1EE.pdf",
  ...
  },
  {
    ...
    url: "https://blobs.vusercontent.net/blob/math-uno-fifa-world-cup-2026-PT-BR-roKn9MUcZolIBk9Ztuj0S6ZGlonvas.pdf",
  ...
  },
  {
    ...
    url: "https://blobs.vusercontent.net/blob/paper-dolls-complete-bundle-PT-BR-ExXPUDy4GpchrP04MLIIaWobTVCq6k.pdf",
    ...
    files: [
      ...
      },
      {
        ...
        pages: 7,
        url: "https://blobs.vusercontent.net/blob/paper-dolls-rumi-PT-BR-OyeQECtFXIPtC08bsPShxw14OpWOq1.pdf",
      ...
      },
      {
        ...
        pages: 6,
        url: "https://blobs.vusercontent.net/blob/paper-dolls-extra-set-PT-BR-aQwvksjrnaFl0Sc5aTVyrenuganxMZ.pdf",
      ...
      },
      {
        ...
        pages: 8,
        url: "https://blobs.vusercontent.net/blob/paper-dolls-dark-skin-brown-hair-PT-BR-hrtbfk1DG86bv37a4vA3RQ142OfM0S.pdf",
      ...
      },
      {
        ...
        pages: 5,
        url: "https://blobs.vusercontent.net/blob/paper-dolls-iphone-craft-PT-BR-Gn7fM1kYpQYvijyCFPs1cC9tQFeX6F.pdf",
