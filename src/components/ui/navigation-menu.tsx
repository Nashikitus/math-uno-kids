...
const NavigationMenuVerport = React.forwardRef<
  React.ElementRef<typeof NavigationMenuPrimitive.Verport>,
  React.ComponentPropsWithoutRef<typeof NavigationMenuPrimitive.Verport>
>(({ className, ...props }, ref) => (
...
NavigationMenuVerport.displayName = NavigationMenuPrimitive.Verport.displayName;
