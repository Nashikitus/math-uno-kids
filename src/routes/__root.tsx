...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "UNO Matemático Kids" },
      {
      ...
      { name: "twitter:title", content: "UNO Matemático Kids" },
      {
...
function RootShell({ children }: { children: ReactNode }) {
  ...
  return (
    <html lang="pt-BR" ref={htmlRef} suppressHydrationWarning>
